...
<img src="http://images.dinosaurpictures.org/elasmosaurus_55bd.jpg" width="40%" />

*Artist's rendering of Elasmosaurus (Note: not technically a dinosaur, but good luck convicing a four-year old of that)*

Suppose that you have a list of dinosaurs:

```
words = ['ankylosaurus', 'brachiosaurus', 'carnotaurus', 'deinonychus', 'elasmosaurus']
```
