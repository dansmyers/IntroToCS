...
Create a `Challenge_Project_2` directory and `cd` into it. Then create a file called `index.html`.

By convention, `index` is the default name for the root page of a web site.
